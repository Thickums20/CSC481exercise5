...
function setupShaders() {
    ...
    var fShaderCode = `
        void main(void) {
            gl_FragColor = vec4(1.0, 1.0, 0.0, 1.0); // all fragments are white
        }
    `;
    ...
    var vShaderCode = `
        ...
        void main(void) {
            vec3 outPos = vec3(-0.25, -0.4, 0.0) + vertexPosition;
            gl_Position = vec4(outPos, 1.0); // use the untransformed position
        }
    `;
